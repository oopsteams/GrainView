<template>
	...
	<el-main style="text-align: left;">
	    ...
	    <el-table :data="tableData" :height="maxHeight" stripe>
	      <el-table-column prop="name" label="组织" width="260">
	      </el-table-column>
		  <el-table-column prop="parent_desc" label="上级组织" width="260">
		  </el-table-column>
	...
	<el-dialog title="创建新角色" :visible.sync="dialogFormVisible">
	  ...
	  <div slot="footer" class="dialog-footer">
	    ...
	    <el-button type="primary" @click="new_org('roleForm')">确 定</el-button>
	  </div>
	</el-dialog>
	</div>
</template>
